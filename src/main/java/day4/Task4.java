/*
4. Создать новый массив размера 1000 и заполнить его случайными числами из диапазона от 0 до 10000.
...
public class Task4 {
    public static void main(String[] args) {
        ...
        System.out.println("Максимальная сумма трех последовательных чисел");
        System.out.println(maxSum);
        System.out.println("Индекс первого числа тройки последовательных чисел с макс суммой");
